...
class TestSubFunctions():
    def test_json_is_loaded_correctly(self):
            ...
            assert result['file_to_obfuscate'] == "s3://my_ingestion_bucket/new_data/file1.csv"
...
class TestMainFunction(unittest.TestCase):
    ...
    def test_main_functions_correctly(
        ...
        mock_transformation_handler.assert_called_once_with(test_csv, test_pii_fields)